...
# 输入 STEP 文件
STEP_FILE = r".\model\step_model\smooth_geometry\Ellipsoid.step"
...
# 尺寸控制（单位与 STEP 模型一致）：
LC_MIN = 10   # 最小特征长度（越小网格越细）
LC_MAX = 30   # 最大特征长度（越大网格越粗）
...
EXPORT_VTK        = True
OUT_VTK_SURFACE   = r".\model\vtp_model\smooth_geometry\Ellipsoid_surface_cellnormals.vtp"   # 原始网格 + cell_normals
OUT_VTK_VERT      = r".\model\vtp_model\smooth_geometry_check\Ellipsoid_vertex_normals_check.vtp"        # 打散顶点 + vertex_normal（看节点箭头）
OBJ_PATH          = r".\model\obj_model\smooth_geometry\Ellipsoid.obj"
